...
const About = () => {
  ...
  return (
    <div ref={ref} className="fade-in">
      <section
        id="about"
        className="flex items-center bg-stone-100 xl:h-screen font-poppins dark:bg-white-900 "
      >
          ...
          <div className="flex flex-wrap ">
            ...
            <div className="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
              <div className="pl-4 mb-6 border-l-4 border-blue-500 ">
                <span className="text-sm text-yellow-600 uppercase dark:text-yellow-400">
                  Who we are?
                </span>
                <h1 className="mt-2 text-3xl font-black text-gray-900 md:text-5xl dark:text-gray-500">
                  About Us
                </h1>
              </div>
